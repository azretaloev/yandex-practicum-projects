# Исследование оттока клиентов банка ([bank-customer-churn-research](https://github.com/azretaloev/yandex-practicum-projects/blob/main/bank-customer-churn-research/bank-customer-churn-research.ipynb))
